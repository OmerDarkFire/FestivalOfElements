    ...
    if (currentPokemon) {
        ...
        if (line.includes(':')) {
            ...
            if (value.startsWith('{') || value.startsWith('[')) {
                Pokedex[currentPokemon][cleanKey] = safeEval(value);
            } else if (value.startsWith('"') || value.startsWith("'")) {
                Pokedex[currentPokemon][cleanKey] = value.slice(1, -1);
            } else if (!isNaN(value)) {
                Pokedex[currentPokemon][cleanKey] = Number(value);
            } else {
                Pokedex[currentPokemon][cleanKey] = value;
            }
        }
    }
});
...
// Your existing generateHTML function here...
    ...
    const formSections = forms.map(form => {
        ...
        <div class="form-section">
            ...
            <div class="sprite-container">
                <h4>רגיל</h4>
                <img src="../sprites/normal/${form.name.toUpperCase()}.png" alt="${form.name} Normal">
            </div>
            <div class="sprite-container">
                <h4>שיני</h4>
                <img src="../sprites/shiny/${form.name.toUpperCase()}.png" alt="${form.name} Shiny">
            </div>
    ...
    <nav>
        <div class="nav-content">
            <ul>
                ...
                <li><a href="../games.html" class="active">פוקידקס</a></li>
