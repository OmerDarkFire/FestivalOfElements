...
pokemons = [
    ...
    "Stunky", "Skuntank", "Bronzor", "Bronzong", "Bonsly", "Mime Jr.", "Happiny", "Chatot", "Spiritomb", "Gible",
    "Gabite", "Garchomp", "Munchlax", "Riolu", "Lucario", "Hippopotas", "Hippowdon", "Skorupi", "Drapion", "Croagunk",
    ...
    "Morpeko", "Cufant", "Copperajah", "Dracozolt", "Arctozolt", "Dracovish", "Arctovish", "Duraludon",
    "Dreepy", "Drakloak", "Dragapult", "Zacian", "Zamazenta", "Eternatus", "Kubfu", "Urshifu", "Zarude",
    "Regieleki", "Regidrago", "Glastrier", "Spectrier", "Calyrex",
    # Generation 9 (905–1025)
    ...
    "Rellor", "Rabsca", "Flittle", "Espathra", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Bombirdier",
    "Finizen", "Palafin", "Varoom", "Revavroom", "Cyclizar", "Orthworm", "Glimmet", "Glimmora", "Greavard", "Houndstone",
    "Flamigo", "Cetoddle", "Cetitan", "Veluza", "Dondozo", "Tatsugiri", "Annihilape", "Clodsire", "Farigiraf",
    ...
    "Roaring Moon", "Iron Valiant", "Koraidon", "Miraidon", "Walking Wake", "Iron Leaves", "Dipplin", "Poltchageist",
    "Sinistcha", "Okidogi", "Munkidori", "Fezandipiti", "Ogerpon", "Terapagos", "Archaludon",
    "Hydrapple", "Gouging Fire", "Raging Bolt", "Iron Boulder", "Iron Crown", "Pecharunt"
]
pokemons = [pokemon.lower() for pokemon in pokemons]
# Generate HTML for each Pokemon
html_output = []
for i, pokemon in enumerate(pokemons, 1):  # start counting from 1
    pokemon_entry = f'''<div class="pokemon-entry">
    <a href="pokemons/{pokemon}.html">
        <img src="sprites/{pokemon}.jpg" alt="{pokemon.title()}" class="normal-sprite">
        <p>#{str(i).zfill(3)} {pokemon.title()}</p>
    </a>
</div>'''
    html_output.append(pokemon_entry)

# Write to file with UTF-8 encoding
with open('pokemon_entries.html', 'w', encoding='utf-8') as f:
    f.write('\n\n'.join(html_output))
print("done")